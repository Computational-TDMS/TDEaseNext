...
Manage the runtime state of interactive visualization nodes, including data caching, selection states, and automatic propagation of changes between connected nodes. This capability enables seamless real-time data exploration without backend round-trips.
