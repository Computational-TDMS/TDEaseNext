...
- [x] **工作流取消功能** (2026-03-04) - **已完成**
  ...
  - 线程安全: 支持并发执行和取消操作
  - 测试覆盖: ProcessRegistry 和 LocalExecutor 的单元测试
...
**实现内容**:
- [ ] 节点输出数据 API（基于工具定义推导输出路径）
- [ ] 工作区文件浏览 API
- [ ] 最新执行查询 API
- [ ] 文件内容预览和解析服务

**预期收益**: 为交互式可视化节点（FeatureMap、Spectrum、Table Viewer）提供必要的数据访问基础设施
...
**预期收益**: 用户可以在前端实时筛选和探索数据，无需重复执行后端处理
